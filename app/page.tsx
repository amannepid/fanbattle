    ...
    <div className="max-w-7xl mx-auto min-h-screen">
        ...
        <div className="relative z-10 px-8 py-20 md:py-32">
          <div className="max-w-2xl">
            <div className="flex items-start mb-4">
              <Trophy className="h-12 w-12 text-gold-500 mr-3 flex-shrink-0" />
              <div className="h-12 w-1 bg-gold-500 mr-4 flex-shrink-0"></div>
              <div className="flex-1">
                <h1 className="text-3xl md:text-5xl font-black text-gold-500 leading-tight">
                  Nepal Premier League
                </h1>
                <h2 className="text-2xl md:text-4xl font-black text-white leading-tight mt-1">
                  FanBattle
                </h2>
                <p className="text-sm md:text-base text-white/60 font-medium mt-2">
                  {tournament.name}
                </p>
                <div className="flex items-center space-x-4 text-white/80 mt-4">
                  <span className="text-sm md:text-base">📅 Nov 17 - Dec 13, 2025</span>
                  <span className="text-sm md:text-base">•</span>
                  <span className="text-sm md:text-base">🏆 32 Matches</span>
                  <span className="text-sm md:text-base">•</span>
                  <span className="text-sm md:text-base">8 Teams</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {user && !userEntry && (
        <div className="mb-8 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-400 dark:border-yellow-600 rounded-lg p-6">
          ...
          <Link
            href="/register"
            className="inline-block px-6 py-3 bg-gold-500 text-navy-500 rounded-button hover:bg-gold-400 transition font-bold shadow-md hover:shadow-lg"
          >
      ...
      {user && userEntry && (
        <div className="mb-8 bg-primary-50 dark:bg-primary-900/20 border-2 border-primary-400 dark:border-primary-600 rounded-lg p-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h3 className="text-lg font-bold text-primary-900 dark:text-primary-200 mb-1">
      ...
      {!user && (
        <div className="mb-8 bg-gradient-to-r from-primary-50 to-blue-50 dark:from-primary-900/20 dark:to-blue-900/20 rounded-lg p-8 text-center">
          ...
          <Link
            href="/login"
            className="inline-block px-8 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-medium text-lg"
          >
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="bg-slate-100 dark:bg-navy-700 rounded-button p-1 inline-flex space-x-1">
          <button
            onClick={() => setFilter('upcoming')}
            className={`px-6 py-2.5 rounded-button font-bold transition-all relative ${
              filter === 'upcoming'
