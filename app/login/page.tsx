            ...
            <div className="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-400 dark:border-yellow-600 rounded-lg">
              ...
              <div className="space-y-2">
                <button
                  ...
                  disabled={signingIn}
                  className="w-full flex items-center justify-between px-4 py-2 bg-yellow-500 text-yellow-900 rounded-lg hover:bg-yellow-400 transition disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                >
                  <span>{TEST_USER_NAMES.USER_1}</span>
                  <span className="text-xs bg-yellow-700 text-yellow-100 px-2 py-1 rounded">ADMIN</span>
                </button>
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-2 bg-yellow-500 text-yellow-900 rounded-lg hover:bg-yellow-400 transition disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                >
                  <span>{TEST_USER_NAMES.USER_2}</span>
                  <span className="text-xs bg-yellow-700 text-yellow-100 px-2 py-1 rounded">PLAYER</span>
                </button>
              </div>
            </div>
          )}
